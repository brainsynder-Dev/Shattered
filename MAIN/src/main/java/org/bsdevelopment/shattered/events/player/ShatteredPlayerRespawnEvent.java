 ...
 */
public class ShatteredPlayerRespawnEvent extends ShatteredEvent {
    private final ShatteredPlayer SHATTERED_PLAYER;
    private final ShatteredGameMode GAMEMODE;

    public ShatteredPlayerRespawnEvent(ShatteredPlayer shattered_player, ShatteredGameMode gameMode) {
